...
# Secrets Manager - Secret Names (matching Azure Key Vault pattern for external-secrets)
...
# PostgreSQL Database Connection Strings (matching hello-azure-v2)
...
output "rds_endpoint_id" {
  description = "ID of the RDS Interface Endpoint"
  value       = var.enable_rds_endpoint ? aws_vpc_endpoint.rds[0].id : null
}
