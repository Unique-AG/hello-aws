...
#######################################
#
# Output values for the infrastructure layer.
...
output "secrets_manager_kms_key_arn" {
  description = "ARN of the KMS key for Secrets Manager (for use in other layers)"
  value       = aws_kms_key.secrets_manager.arn
}
...
#######################################
# Bastion and Management Server Outputs
#######################################
