...
# - General encryption key: For EKS secrets, EBS volumes, S3, RDS, ElastiCache
# - Secrets Manager key: For Secrets Manager encryption
# - CloudWatch Logs key: For CloudWatch Log Groups encryption
# - Prometheus key: For Managed Prometheus workspace encryption
#
# All encryption keys are centralized in the infrastructure layer
#######################################
